        ...
        <div className="px-8 pt-10 pb-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <button
              ...
              disabled={isLoading}
              className="flex flex-col items-center justify-center rounded-2xl border border-emerald-250 bg-emerald-50 py-3 transition-all duration-200 hover:bg-emerald-100 hover:border-emerald-400 group cursor-pointer"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="flex flex-col items-center justify-center rounded-2xl border border-sky-250 bg-sky-50 py-3 transition-all duration-200 hover:bg-sky-100 hover:border-sky-400 group cursor-pointer"
            >
